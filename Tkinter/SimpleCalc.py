...
button_eq = Button(root, text = "=", padx = 91, pady = 20, command = button_el)
button_cl = Button(root, text = "Clear", padx = 79, pady = 20, command = button_clear)

button_su = Button(root, text = "-", padx = 41, pady = 20, command = button_sub)
button_mu = Button(root, text = "*", padx = 40, pady = 20, command = button_mul)
button_di = Button(root, text = "/", padx = 40, pady = 20, command = button_div)

#Button placements on screen
